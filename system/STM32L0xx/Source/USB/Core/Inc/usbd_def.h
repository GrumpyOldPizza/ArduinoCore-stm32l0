...
#define  USB_REQ_DIRECTION_HOST_TO_DEVICE               0x00U
#define  USB_REQ_DIRECTION_DEVICE_TO_HOST               0x80U
...
typedef struct _USBD_HandleTypeDef
{
  ...
  uint16_t                ep0_in_total_length;
  uint16_t                ep0_in_rem_length;
  uint16_t                ep0_out_total_length;
  uint16_t                ep0_out_rem_length;
  uint8_t                 dev_state;
