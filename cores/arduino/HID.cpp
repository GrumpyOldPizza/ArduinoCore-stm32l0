...
void KeyboardClass::begin(void) 
{
}

void KeyboardClass::end(void) 
{
}
...
size_t KeyboardClass::press(uint8_t k) 
{
	uint8_t i;
...
size_t KeyboardClass::release(uint8_t k) 
{
	uint8_t i;
	if (k >= 136) {			// it's a non-printing key (not a modifier)
		k = k - 136;
...
size_t KeyboardClass::write(uint8_t c)
{	
