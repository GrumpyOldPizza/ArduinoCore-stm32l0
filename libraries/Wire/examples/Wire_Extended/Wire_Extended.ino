/* Extened Wire Sensor example
 *    
 * The code is using the extended core Wire interface to
 * communicate with a BME280 sensor and print temperature,
 * pressure and humidity samples every 10 seconds.
 *
 * Wire.requestFrom() with a index is used to simplify
 * the reading of sensor data.
 *
...
void loop()
{
    ...
    Wire.requestFrom(BME280_I2C_ADDRESS, 8, 0xf7, 1);
...
void bme280_read_calibration_data()
{
    ...
    Wire.requestFrom(BME280_I2C_ADDRESS, 26, 0x88, 1);
    Wire.read(&data[0], 26);
    ...
    Wire.requestFrom(BME280_I2C_ADDRESS, 7, 0xe1, 1);
    Wire.read(&data[0], 7);
